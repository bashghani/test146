...
<html lang="en">
<head>
<title>Portfolio-OakwellRex Taxis</title>
<!-- for-mobile-apps -->
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="{{ url('/portfolio')}}" class="hvr-sweep-to-bottom">Portfolio</a></li>
...
<!-- portfolio -->
	<div class="portfolio">
		...
		<div class="w3_agile_portfolio_grids" style="z-index: 100000 !important;">
			<div class="agile_portfolio_grid">
				<div class="w3_agileits_portfolio_grid">
					<a href="images/portpic1.jpg" >
						<div class="view effect">
							<img src="images/portpic1.jpg" alt=" " class="img-responsive" />
							<div class="mask"></div>
							<div class="content">
								<h4>Oakwell & Rex taxis</h4>
							</div>
						</div> 
					</a>
				</div>
				<div class="w3_agileits_portfolio_grid">
					<a href="images/portpic2.jpg" >
						<div class="view effect">
			...
			<div class="agile_portfolio_grid">
				<div class="w3_agileits_portfolio_grid">
					<a href="images/portpic5.jpg" >
						<div class="view effect">
							<img src="images/portpic5.jpg" alt=" " class="img-responsive" />
							<div class="mask"></div>
							<div class="content">
								<h4>Oakwell & Rex taxis</h4>
							</div>
