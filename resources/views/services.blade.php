...
<html lang="en">
<head>
<title>Services-OakwellRex taxis</title>
<!-- for-mobile-apps -->
...
<img src="images/logowhite-large.jpg" alt="1" title="1" id="wows1_0" class="hidden-xl hidden-lg hidden-md hidden-sm"/>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="{{ url('/services')}}" class="hvr-sweep-to-bottom">Services</a></li>
			...
			<div class="w3_agile_services_grids">
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="images/portpic7.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
				...
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="images/portpic10.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
				...
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="images/portpic6.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
