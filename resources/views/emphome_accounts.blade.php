         ...
         <div class="col-md-12">
            <div class="panel panel-success">
                <div class="panel-heading">Dashboard For New Contact Us Messages</div>
                 ...
                 &nbsp;<a href="{{ url('/accounts_home') }}"><button  class="btn btn-success">
                                    <i class="fa fa-list-alt"></i>&nbsp;&nbsp;Pending Messages
                                </button></a>
                                <a href="{{ url('/completed_accounts') }}"><button  class="btn btn-success">
                                    <i class="fa fa-list-alt"></i>&nbsp;&nbsp;Completed Accounts
                                </button></a>
                                
                                <a href="{{ url('/cancelled_accounts') }}"><button  class="btn btn-success">
                                    <i class="fa fa-list-alt"></i>&nbsp;&nbsp;Cancelled accounts
                                </button></a>
...
<div class="container">
	<div class="row">
        ...
        <div class="col-sm-11">
        <h4>New Accounts Applications </h4>
...
<tr>
 ...
 <div class="panel-body">
 <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/edit_accounts_application') }}">
                        {!! csrf_field() !!}
      ...
      {{-- <option value="pending">pending</option> --}}
        ...
        <option value="cancelled">cancelled</option>
                      ...
                      <input type="hidden" name="j_id"  value="{{ $emp_job['id'] }}">
                        <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i>Edit Publication
                                </button>
                                 @endif 
                                </form>
