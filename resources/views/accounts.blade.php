...
<html lang="en">
<head>
<title>Accounts OakwellRex taxis</title>
<!-- for-mobile-apps -->
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="{{ url('/accounts')}}" class="hvr-sweep-to-bottom">Accounts</a></li>
...
<p class="alert {{ Session::get('alert-class', 'alert-info') }}"><b>{{ Session::get('message') }}</b></p>
@endif
{{--end session code--}}
	<div class="services">
		<div class="container">
		<h3 class="agile_head">Accounts </h3>
			<p class="w3_agile_para">Please fill form for Accounts application. </p>
			<div class="agileits_w3layouts_contact_grids">
				...
				<div class="col-md-5 agileits_w3layouts_contact_gridl">
					...
					<div class="agileits_mail_grid_right_grid">
						...
						<ul class="contact_info">
							...
							<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="info@oakwelltaxis.co.uk">info@oakwelltaxis.co.uk</a></li>
				...
				<div class="col-md-7 agileits_w3layouts_contact_gridr">
					...
					<form action="{{ url('/account_application') }}" method="post">
		...
		<div class="container">
			<div class="w3ls_copyright_left">
				...
				<li><a href="{{ url('/services')}}">Services</a></li>
					...
					<li class="active"><a href="{{ url('/accounts')}}">Accounts</a></li>	
