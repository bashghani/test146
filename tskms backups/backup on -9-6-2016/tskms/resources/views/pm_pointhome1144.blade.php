    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Dashboard For Project Manager</div> {{-- <a href="{{ url('/toaddash') }}"><button  class="btn btn-primary">
                ...
                <div class="panel-body">
                    ...
                    {{-- <br>{{ Auth::user()->first_name }} </br>
                      ...
                      <h1>Project Manager points dashboard</h1></br></br></br></br>
...
@if ($errors->has('dept'))
                       ...
                       <div id="flipforjobsopen" > Cancel adding new Users sss          </div>
                         ...
                         <!--  <button class="btn btn-primary" id="flipforjobs">
                            ...
                            <form method="post" action="{{url('serc_for_points_pm')}}" accept-charset="UTF-8">
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
    ...
    <td>{{$ser_user['email']}}</td>
         ...
         <td><form class="form-horizontal" role="form" method="POST" action="{{ url('/pmvwdetails') }}">
                        {!! csrf_field() !!}
