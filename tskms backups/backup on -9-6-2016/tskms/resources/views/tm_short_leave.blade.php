    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Team lead Apply Short Leave section</div>
                 <div> </div>
                 <div id="topcorner" > 
                                <a href="{{ url('/all_tm_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-calendar-plus-o"></i>&nbsp;All Short leaves
                                </button></a> 
                                
                                <a href="{{ url('/cancelled_tm_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-times-o"></i>Cancelled Short leaves
                                </button></a>  
                                 
                                <a href="{{ url('/approved_tm_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-check-o"></i>Approved Short leaves
                                </button></a> 
                                                                
                                
                                <a href="{{ url('/pending_tm_sh_leave_app') }}"><button  class="btn btn-info">
...
<tr>
 ...
 <div class="panel-body">
 <form class="form-horizontal" role="form" method="POST" action="{{ url('/tm_edit_sh_leave') }}">
                        {!! csrf_field() !!}
