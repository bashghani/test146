    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Team member Leave application section</div>
                 <div> </div>
                 <div id="topcorner" > 
                                <a href="{{ url('/all_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-calendar-plus-o"></i>All Applications
                                </button></a> 
                                
                                <a href="{{ url('/cancelled_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-times-o"></i>Cancelled Applications
                                </button></a>  
                                 
                                <a href="{{ url('/approved_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-check-o"></i>Approved Applications
                                </button></a> 
                                                                
                                
                                <a href="{{ url('/pending_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-o"></i>Pending Applications
                                </button></a> </a> </div>
                <div class="panel-body">
                 <h1>Team member Leave application section</h1></br></br>
