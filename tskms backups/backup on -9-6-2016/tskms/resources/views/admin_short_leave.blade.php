    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Admin Short Leave section</div>
                 <div> </div>
                 <div id="topcorner" > 
                                <a href="{{ url('/admin_all_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-calendar-plus-o"></i>&nbsp;All Short leaves
                                </button></a> 
                                
                                <a href="{{ url('/cancelled_sh_leave_app_admin') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-times-o"></i>Cancelled Short leaves
                                </button></a>  
                                 
                                <a href="{{ url('/admin_approved_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-check-o"></i>Approved Short leaves
                                </button></a> 
                                                                
                                
                                <a href="{{ url('/admin_pending_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-o"></i>Pending Short leaves
                                </button></a> </a> </div>
                <div class="panel-body">
                 <h1>Admin Short Leave section</h1></br></br>
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
 ...
 {{--  <td><form class="form-horizontal" role="form" method="POST" action="{{ url('/deleteproject') }}" 
    ...
    <td><form class="form-horizontal" role="form" method="POST" action="{{ url('/admin_view_sh_report') }}">
                        {!! csrf_field() !!}
...
<tr>
 ...
 <div class="panel-body">
 <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin_mang_sh_leave') }}">
                        {!! csrf_field() !!}
