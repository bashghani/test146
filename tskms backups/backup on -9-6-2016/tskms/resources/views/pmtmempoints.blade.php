    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Dashboard For Project Manager points</div>
                 <div> </div>
                <div class="panel-body">
              <h1>Project Manager  points section</h1></br></br></br>
...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/pmanagerdatefilter') }}">
                        {!! csrf_field() !!}
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
    ...
    <td>{{$ser_user['comments_of_day']}}</td>
         ...
         <td>{{$ser_user['Evaluated_by']}}
         {{--<form class="form-horizontal" role="form" method="POST" action="{{ url('/vwdetails') }}">
                        {!! csrf_field() !!}
