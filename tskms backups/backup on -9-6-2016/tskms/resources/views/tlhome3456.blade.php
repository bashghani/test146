    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Team lead Dashboard</div>
                 <div> </div>
                 <div id="topcorner" > 
                ...
                <div class="panel-body">
                 <h1>Team lead Dashboard</h1></br></br>
...
@if ($errors->has('dept'))
                        ...
                        <div align="center">  &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;     <button id="flipforjobsopen" class="btn btn-danger">
                         ...
                         <div align="center"> <button id="flipforjobs" class="btn btn-success">
                                 Add New  Task &nbsp;<i class="fa fa-sort-desc"></i> 
                                </button>  </div>        
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
    ...
    <td><form class="form-horizontal" role="form" method="POST" action="{{ url('/view_to_dos_tl') }}">
                        {!! csrf_field() !!}
