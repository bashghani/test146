...
<body id="app-layout">
    ...
    <div class="row">
        ...
        <h4>  {{$ser_user1['first_name']}}
          {{$ser_user1['first_name']}}</h4><br>
          Team member ID  {{$team_member_id=$ser_user1['first_name']}}
         <br>Email  {{$ser_user1['email']}}
          <br>Designation {{-- {{$ser_user1['type_of']}} --}}&nbsp;Team member
           <br>Deparatment &nbsp;  {{$ser_user1['first_name']}}
           </div>
         @endforeach	
...
?>
                         ...
                         <!--  <button class="btn btn-primary" id="flipforjobs">
                               ...
                               -->
                                  ...
                                  <div class="col-md-6">
                          {{--  <form method="post" action="{{url('first_name')}}" accept-charset="UTF-8">
...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/datefilter') }}">
                        {!! csrf_field() !!}
    <input type="hidden" name="user_id_data"  value="{{first_name}}">
...
@if ($errors->has('type_of'))
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('password'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('Points score') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if      ($errors->has('{{$ser_user['dept']}}'))
                                     <span class="help-block">
                                         <strong>{{ $errors->first('Points scored') }}</strong>
                                     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span>
                                @endif
                            </div>
                        </div>
