    ...
    <div class="row">
        ...
        <h4>  {{$ser_user1['first_name']}}
         ...
         @endforeach	
            ...
            <div id="panelforjobs" >
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/app_leave_tl') }}">
                        {!! csrf_field() !!}
...
@if ($errors->has('leave_type'))
                        ...
                        <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('team_lead_for_approval') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Person for approval </label>
...
<tr>
 ...
 <div class="panel-body">
 <form class="form-horizontal" role="form" method="POST" action="{{ url('/tl_apply_edit_leave') }}">
                        {!! csrf_field() !!}
