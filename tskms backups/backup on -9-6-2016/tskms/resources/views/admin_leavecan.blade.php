    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Admin leave application section</div>
                 <div> </div>
                 <div id="topcorner" > 
                                <a href="{{ url('/all_leave_app_admin') }}"><button  class="btn btn-info">
                                    <i class="fa fa-calendar-plus-o"></i>All Applications
                                </button></a> 
                                
                                <a href="{{ url('/cancelled_leave_app_admin') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-times-o"></i>Cancelled Applications
                                </button></a>  
                                 
                                <a href="{{ url('/approved_leave_app_admin') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-check-o"></i>Approved Applications
                                </button></a> 
                                                                
                                
                                <a href="{{ url('/pending_leave_app_admin') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-o"></i>Pending Applications
                                </button></a>  </a> </div>
                <div class="panel-body">
                 <h1>Admin leave application section</h1></br></br>
...
@if ($errors->has('team_lead_for_approval'))
                      ...
                      {{--   <div align="center"> <button id="flipforjobs" class="btn btn-success">
                                ...
                                </button>  </div>  --}}<h3>Leave applications</h3>       
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
    ...
    <span class="glyphicon glyphicon-th-large"></span></p></span> </td>
     <td><form class="form-horizontal" role="form" method="POST" action="{{ url('/view_report_admin') }}">
                        {!! csrf_field() !!}
