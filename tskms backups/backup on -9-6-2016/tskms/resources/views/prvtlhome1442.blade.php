...
<div class="container">
	...
	function show(select_item) {
		...
		newd="hiddenDiv"+"{{$project_member->id}}";
...
<label>Fruit:</label>
    <select name="Fruit" onchange="java_script_:show(this.options[this.selectedIndex].value)">
        <option value='pear'>pryehmmmms</option>
        <option value='apple'>aped</option>
        <option value='grapes'>gradfef</option>
    </select>

<div id='hiddenDivabc'>
    <label>Are you sure you want to eat the apple?</label>
    <select name="AppleQuestion">
        <option value='Yes'>Yohyes</option>
...
<select name="task_assigned_to">
  ...
  <option disabled selected > -- select team member -- </option>
   ...
   {{$team_member->member_name}}---- ID:{{$team_member->member_id}}--{{$all_team_by['team_project_id']}}
...
onchange="java_script_:show(this.options[this.selectedIndex].value)" >
  <option disabled selected > -- select proje -- </option>
 @foreach($tl_projects as $project_member)
