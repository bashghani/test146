    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Team lead Apply Short Leave </div>
                 <div> </div>
                 <div id="topcorner" > 
                                <a href="{{ url('/all_applied_tl_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-calendar-plus-o"></i>&nbsp;All Short leaves
                                </button></a> 
                                
                                <a href="{{ url('/cancelled_applied_tl_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-times-o"></i>Cancelled Short leaves
                                </button></a>  
                                 
                                <a href="{{ url('/approved_applied_tl_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-check-o"></i>Approved Short leaves
                                </button></a> 
                                                                
                                
                                <a href="{{ url('/pending_applied_tl_sh_leave_app') }}"><button  class="btn btn-info">
                                    <i class="fa fa-btn fa-calendar-o"></i>Pending Short leaves
                                </button></a> </a> </div>
                <div class="panel-body">
                 <h1>Team lead Apply Short Leave  section</h1></br></br>
        ...
        <h4>  {{$ser_user1['first_name']}}
         ...
         @endforeach	
            ...
            <div id="panelforjobs" >
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/tl_apply_short_leave') }}">
                        {!! csrf_field() !!}
...
<tr>
 ...
 <div class="panel-body">
 <form class="form-horizontal" role="form" method="POST" action="{{ url('/tl_apply_edit_sh_leave') }}">
                        {!! csrf_field() !!}
...
<select name="leave_type" required>
 ...
 <option selected value="{{$detail_leaves['leave_type']}}">{{$detail_leaves['leave_type']}} leave</option>
  <option value="casual">Casual</option>
  <option value="sick">Sick</option>
   <option value="other">Other</option>
  </select>
@if ($errors->has('leave_type'))
                          ...
                          <div class="form-group{{ $errors->has('applicant_comment') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="applicant_comment" 
                                value="{{$detail_leaves['applicant_comment']}}" required>
...
@if ($errors->has('status'))
  ...
  <input type="text"  id="{{$disp=$detail_leaves['id']."abcef"}}" class="form-control" name="start_time" 
   value="{{$detail_leaves['start_time']}}" required >
                        ...
                        <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                           ...
                           {{-- <input type="text" class="form-control" name="applicant_comment" 
                        value="{{ old('end_date') }}" required> --}}
  <input type="text"  id="{{$disp=$detail_leaves['id']."abcefd"}}" class="form-control" name="end_time" value="{{$detail_leaves['end_time']}}" required >
