    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Team leader Apply Short Leave  section</div>
                 <div> </div>
                 <div id="topcorner" > 
                ...
                <div class="panel-body">
                 <h1>Team leader Apply Short Leave </h1></br></br>
...
@if ($errors->has('leave_type'))
  ...
  <input type="text"  id="{{$disp=$detail_leaves['id']."abcefd"}}" class="form-control" name="end_time" value="{{$detail_leaves['end_time']}}" disabled >
                        ...
                        <div class="form-group{{ $errors->has('Status_updated_by') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Status updated by</label>
